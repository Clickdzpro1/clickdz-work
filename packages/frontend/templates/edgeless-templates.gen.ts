...
import EntonnoirMarketing from './edgeless/Entonnoir Marketing.json';
import Storyboard from './edgeless/Storyboard.json';
import UserJourneyMap from './edgeless/User Journey Map.json';
import MindMapContenu from './edgeless/Mind Map Contenu.json';
import MindMapProduit from './edgeless/Mind Map Produit.json';
import MindMapProjet from './edgeless/Mind Map Projet.json';
import FlowchartProcessus from './edgeless/Flowchart Processus.json';
import Kanban from './edgeless/Kanban.json';
import Organigramme from './edgeless/Organigramme.json';
