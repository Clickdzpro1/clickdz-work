    ...
    const errorTemplate = choose(
      ...
      [
        [
          ...
          () =>
            html` <div class="error-info">
                You need to login to ClickDz Cloud to continue using ClickDz AI.
              </div>
        ...
        [
          ...
          () =>
            html` <div class="error-info">
                You've reached the current usage cap for ClickDz AI. You can
                subscribe to ClickDz AI(with free 7-day-trial) to continue the AI
                experience!
              </div>
              <div class="action-button-group">
                <div @click=${this.config.cancel} class="action-button">
      ...
      () => {
        ...
        return html`
          ...
          <div class="error-info">
            ...
            us know at
            <a href="mailto:support@clickdz.ai">
              support@clickdz.ai
            </a>
          </div>
        `;
