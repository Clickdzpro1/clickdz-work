...
import { CourseProPanel } from '../shoperp/coursepro';

// ---------------------------------------------------------------------------
// CoursePro — top-level sidebar entry (promoted out of the ERP dashboard's tab
...
//
// CourseProPanel's `slug` prop was designed for a shop-scoped context (it's
