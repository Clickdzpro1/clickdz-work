...
// ---------------------------------------------------------------------------
// "Votre ERP en 5 étapes" — the first-run checklist, shown at the top of
...
const FiveSteps = ({
  ...
  const steps: Array<{
    ...
    },
    {
      ...
      hint: 'Thème, couleurs et mise en page du site.',
      section: 'appearance',
      done:
    ...
    },
    {
      ...
      hint: 'Ouvrez votre site et commandez comme un client.',
      section: 'orders',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      >
        ...
        <Panel title="Commandes par statut">
          {!hasAnyOrder ? (
            <EmptyNote>
              Aucune commande pour le moment — partagez le lien de votre site pour commencer à vendre.
            </EmptyNote>
          ) : (
            <ResponsiveContainer width="100%" height={220}>
              <BarChart
