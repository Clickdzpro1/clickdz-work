/**
 * CDZ Chat — shared icons for the main chat input (claude-style).
 *
 * Re-exports the lucide-react icons the component uses, plus the ClickDz
 * starburst/logo mark used in the greeting. Keeping these in one place lets us
 * swap icon sources (lucide vs inline SVG) without touching the component.
 */
import {
  Archive,
  ArrowUp,
...
export const Icons = {
  Logo: (props: SVGProps<SVGSVGElement>) => (
    ...
    >
      <defs>
        <ellipse id="cdz-petal-pair" cx="100" cy="100" rx="90" ry="22" />
      </defs>
      <g fill="#D46B4F" fillRule="evenodd">
        <use href="#cdz-petal-pair" transform="rotate(0 100 100)" />
        <use href="#cdz-petal-pair" transform="rotate(45 100 100)" />
        <use href="#cdz-petal-pair" transform="rotate(90 100 100)" />
        <use href="#cdz-petal-pair" transform="rotate(135 100 100)" />
      </g>
    </svg>
  ),
  Plus,
  Thinking: (props: SVGProps<SVGSVGElement>) => (
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
