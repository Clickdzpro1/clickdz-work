...
export function useAFFiNEI18N(): {
    ...
    Enable(): string;
    /**
      * `Enable ClickDz Work Sync`
      */
    ["Enable AFFiNE Cloud"](): string;
    /**
      * `Your workspace will be synced and backed up with ClickDz Work Sync.`
      */
    ["Enable AFFiNE Cloud Description"](): string;
    /**
      * `Some features need ClickDz Work Sync. Web workspaces are saved in this browser and may be removed automatically when disk space is low. Enable ClickDz Work Sync to keep this workspace safer and available across devices.`
      */
    ...
    /**
      * `View the ClickDz Work Changelog.`
      */
    ...
    /**
      * `You've got the latest version of ClickDz Work.`
      */
    ...
    /**
      * `Information about ClickDz Work`
      */
    ...
    /**
      * `Answer questions, draft docs, visualize ideas - ClickDz AI can save you time at every possible step. Powered by GPT's most powerful model.`
      */
    ["com.affine.ai-onboarding.general.2.description"](): string;
    /**
      * `Chat with ClickDz AI`
      */
    ...
    /**
      * `To use ClickDz AI, please sign in to your ClickDz Cloud account.`
      */
    ...
    /**
      * `Edit all ClickDz Work theme variables here`
      */
    ...
    /**
      * `Customize your ClickDz Work appearance`
      */
    ...
    /**
      * `Display the menubar app in the tray for quick access to ClickDz Work or meeting recordings.`
      */
    ...
    /**
      * `Open ClickDz Work when left‑clicking the tray icon.`
      */
    ...
    /**
      * `Minimize ClickDz Work to the system tray.`
      */
    ...
    /**
      * `Close ClickDz Work to the system tray.`
      */
    ...
    /**
      * `Start ClickDz Work minimized to the system tray.`
      */
    ...
    /**
      * `Congratulations! You have successfully updated the email address associated with your ClickDz Work account.`
      */
    ...
    /**
      * `Requires ClickDz Work desktop app version 0.18 or later.`
      */
    ...
    /**
      * `Welcome to ClickDz Work, you're almost there!`
      */
    ...
    /**
      * `Reset your ClickDz Work password`
      */
    ...
    /**
      * `Your password has been updated! You can sign in to ClickDz Work with the new password.`
      */
    ...
    /**
      * `Your password has been saved! You can sign in to ClickDz Work with email and password.`
      */
    ...
    /**
      * `Set your ClickDz Work password`
      */
    ...
    /**
      * `The app will automatically open or redirect to the web version. If you encounter any issues, you can also click the button below to manually open the ClickDz Work app.`
      */
    ...
    /**
      * `You have successfully signed in. The app will automatically open or redirect to the web version. if you encounter any issues, you can also click the button below to  manually open the ClickDz Work app.`
      */
    ...
    /**
      * `You have signed in to ClickDz Work.`
      */
    ...
    /**
      * `Your workspace is saved in this browser. When disk space is low, the browser may remove it automatically. Enable ClickDz Work Sync to keep it safer.`
      */
    ...
    /**
      * `Host by ClickDz Work.Pro, Save, sync, and backup all your data.`
      */
    ...
    /**
      * `Enable ClickDz Work Sync for {{workspaceName}}`
      */
    ...
    /**
      * `Version history can't work with local workspace. Enable ClickDz Work Sync for this workspace to use version history.`
      */
    ["com.affine.history-vision.tips-modal.description"](): string;
    /**
      * `Version history needs ClickDz Work Sync`
      */
    ...
    /**
      * `Import your Bear note backup. Tags will be converted to ClickDz Work tags and folders.`
      */
    ...
    /**
      * `This format importer is available in the ClickDz Work desktop app.`
      */
    ...
    /**
      * `Import your ClickDz Work workspace and page snapshot file.`
      */
    ...
    /**
      * `Import your ClickDz Work db file (.ClickDz Work)`
      */
    ...
    /**
      * `Your document has been imported successfully, thank you for choosing ClickDz Work. Any questions please feel free to feedback to us`
      */
    ...
    /**
      * `Start ClickDz Work without an account`
      */
    ...
    /**
      * `ClickDz Work Sync keeps your workspace backed up, available across devices, and ready for collaboration and publishing.`
      */
    ["com.affine.nameWorkspace.affine-cloud.description"](): string;
    /**
      * `Sync across devices with ClickDz Work Sync`
      */
    ...
    /**
      * `Enter a link to websites or ClickDz Work docs. Useful for connecting to external resources and referencing internal docs.`
      */
    ...
    /**
      * `Congratulations on your successful purchase of ClickDz AI! You're now empowered to refine your content, generate images, and craft comprehensive mindmaps directly within ClickDz AI, dramatically enhancing your productivity.`
      */
    ...
    /**
      * `If you end your subscription now, you can still use ClickDz AI until the end of this billing period.`
      */
    ...
    /**
      * `Are you sure you want to resume the subscription for ClickDz AI? This means your payment method will be charged automatically at the end of each billing cycle, starting from the next billing cycle.`
      */
    ...
    /**
      * `You have purchased ClickDz AI. The expiration date is {{end}}.`
      */
    ["com.affine.payment.ai.billing-tip.end-at"](options: {
        readonly end: string;
    }): string;
    /**
      * `You have purchased ClickDz AI. The next payment date is {{due}}.`
      */
    ...
    /**
      * `Please tell us more about your use case, to make ClickDz Work better.`
      */
    ...
    /**
      * `Everything in ClickDz Work FOSS & Basic.`
      */
    ...
    /**
      * `Everything in ClickDz Work Pro.`
      */
    ...
    /**
      * `We'd like to hear more about where we fall short, so that we can make ClickDz Work better.`
      */
    ...
    /**
      * `Dedicated Discord support with ClickDz Work makers`
      */
    ...
    /**
      * `Upgrade to ClickDz Work Pro for expanded member capacity`
      */
    ...
    /**
      * `You can still use ClickDz Cloud Pro until the end of this billing period :)`
      */
    ["com.affine.payment.modal.downgrade.caption"](): string;
    /**
      * `Keep ClickDz Cloud Pro`
      */
    ...
    /**
      * `This is the pricing plans of ClickDz Cloud. You can sign up or sign in to your account first.`
      */
    ...
    /**
      * `We'd like to hear more about your use case, so that we can make ClickDz Work better.`
      */
    ...
    /**
      * `Congratulations! Your ClickDz Work account has been successfully upgraded to a Pro account.`
      */
    ...
    /**
      * `Thank you for purchasing the ClickDz Work self-hosted license.`
      */
    ...
    /**
      * `Doc analytics over 7 days require an ClickDz Work Team subscription.`
      */
    ...
    /**
      * `Open this doc in ClickDz Work app`
      */
    ...
    /**
      * `Enable the powerful AI assistant, ClickDz AI.`
      */
    ...
    /**
      * `Enable ClickDz Work Sync to collaborate with others`
      */
    ...
    /**
      * `ClickDz Work will generate meeting notes by recording your meetings. Authorization to "Screen & System Audio Recording" is necessary.`
      */
    ...
    /**
      * `Use workspace provider keys before ClickDz AI plan routes.`
      */
    ...
    /**
      * `Upgrade this workspace to add provider keys and route ClickDz AI through your own OpenAI, Anthropic, Gemini, or FAL account.`
      */
    ...
    /**
      * `Local keys on this device are tried first. Workspace server keys follow, then ClickDz AI plan routes when quota is available.`
      */
    ...
    /**
      * `Transcript and workspace indexing require a server Gemini BYOK key or ClickDz AI plan fallback.`
      */
    ["com.affine.settings.workspace.byok.warning.transcript"](): string;
    /**
      * `Workspace indexing requires a server Gemini BYOK key or ClickDz AI plan fallback.`
      */
    ...
    /**
      * `Meetings allows you to record and transcribe meetings. Don't forget to enable it in ClickDz Work settings.`
      */
    ...
    /**
      * `If you encounter any issues, contact support@clickdz.ai.`
      */
    ...
    /**
      * `Enable ClickDz Work Sync to publish this workspace`
      */
    ...
    /**
      * `Allow ClickDz AI Assistant`
      */
    ["com.affine.settings.workspace.affine-ai.label"](): string;
    /**
      * `Allow workspace members to use ClickDz AI features. This setting doesn't affect billing. Workspace members use ClickDz AI through their personal accounts.`
      */
    ...
    /**
      * `Manage ClickDz Work indexing and ClickDz AI Embedding for local content processing`
      */
    ...
    /**
      * `Sharing docs requires ClickDz Work Sync.`
      */
    ...
    /**
      * `Empower your sharing with ClickDz Cloud: One-click doc sharing`
      */
    ...
    /**
      * `To ensure compatibility with the updated ClickDz Work client, please upgrade your data by clicking the "Upgrade workspace data" button below.`
      */
    ...
    /**
      * `Sign in / Sign up to ClickDz Work`
      */
    ...
    /**
      * `Failed to turn on ClickDz Work Sync. Please try again.`
      */
    ...
    /**
      * `Import web pages to ClickDz Work`
      */
    ["com.affine.integration.web-clipper.desc"](): string;
    /**
      * `Elevate your ClickDz Work experience with diverse add-ons and seamless integrations.`
      */
    ["com.affine.integration.setting.description"](): string;
    /**
      * `Learn how to develop a integration for ClickDz Work`
      */
    ...
    /**
      * `Manually import your content to ClickDz Work from Readwise`
      */
    ...
    /**
      * `Once disconnected, content will no longer be imported. Do you want to keep your existing highlights in ClickDz Work?`
      */
    ...
    /**
      * `New Readwise highlights will be imported to ClickDz Work `
      */
    ["com.affine.integration.readwise.setting.sync-new-name"](): string;
    /**
      * `New highlights in Readwise will be synced to ClickDz Work `
      */
    ...
    /**
      * `New events will be scheduled in ClickDz Work’s journal`
      */
    ...
    /**
      * `Enabling this setting allows you to connect your calendar events to your Journal in ClickDz Work`
      */
    ...
    /**
      * `Enable other MCP Client to search and read the doc of ClickDz Work.`
      */
    ...
    /**
      * `This ClickDz Work server is too old for this client. Please upgrade the server to {{requiredVersion}}.`
      */
...
export const TypedTrans: {
    /**
      * `Go to <a>{{link}}</a> for learn more details about ClickDz AI.`
      */
    ...
    /**
      * `Opening <1>ClickDz Work</1> app now`
      */
    ["com.affine.auth.open.affine.prompt"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `This doc is now opened in <1>ClickDz Work</1> app`
      */
    ...
    /**
      * `This is an ClickDz Work server hosted by you or your team. After signing in, workspace data is saved to the ClickDz Work server you enter, not to ClickDz Cloud. <1>Learn more about self-hosting.</1>`
      */
    ["com.affine.auth.sign.add-selfhosted.description"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `By clicking “Continue with Google/Email” above, you acknowledge that you agree to ClickDz Work's <1>Terms of Conditions</1> and <3>Privacy Policy</3>.`
      */
    ...
    /**
      * `This demo is limited. <1>Download the ClickDz Work Client</1> for the latest features and Performance.`
      */
    ...
    /**
      * `<strong>Where AI meets your meetings - ClickDz Work your collaboration.</strong>
    ...
    /**
      * `Utilize the meeting notes and AI summarization features provided by ClickDz Work. <1>Discuss more in the community</1>.`
      */
    ...
    /**
      * `If you encounter any issues, contact support@clickdz.ai. No license yet? <1>Click to purchase</1>.`
      */
    ...
    /**
      * `Import your Readwise highlights to ClickDz Work. Please visit Readwise, <br />click <a>"Get Access Token"</a>, and paste the token below.`
      */
