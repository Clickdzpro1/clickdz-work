  ...
  async reconcileWorkspaceStorageBySid({
    ...
    for (const workspace of workspaces) {
      try {
        ...
        // upstream 0.27.3 added this counter; kept alongside our
        // handleSweepFailure, which additionally recovers from Prisma
        // pool-timeout pressure instead of only logging.
        metrics.storage
