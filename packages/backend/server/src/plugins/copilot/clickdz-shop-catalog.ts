...
export const TEMPLATE_CATALOG: TemplateDef[] = [
  ...
  /* ── 6 · Mode — Mode femme ─────────────────────────────────────────────── */
  {
    ...
    vertical: 'mode femme',
    category: 'Mode',
    icp: 'Boutiques mode femme, collections saisonnieres, livraison 69 wilayas + COD.',
    emoji: '👗',
    accent: '#be185d',
    theme: 'vibrant',
    font: 'playfair',
    ...
    tagline: 'Nouvelle collection — livraison 69 wilayas, paiement a la livraison.',
    heroLine: 'Nouvelle collection — livraison 69 wilayas, paiement a la livraison',
  ...
  /* ── 17 · Général — Sport & Fitness ────────────────────────────────────── */
  {
    ...
    vertical: 'sport',
    category: 'Général',
    icp: 'Boutiques equipement sport & fitness, home-training, COD 69 wilayas.',
    emoji: '🏋️',
    accent: '#ea580c',
    theme: 'dark',
    font: 'poppins',
    ...
    tagline: 'Equipement sport & fitness — COD, 69 wilayas.',
    heroLine: 'Equipement sport & fitness — COD, 69 wilayas',
