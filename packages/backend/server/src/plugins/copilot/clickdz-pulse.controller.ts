...
const FALLBACK_LINES: Record<PulseSurface, string[]> = {
  video: [
    ...
    'Cadrage du plan d’ouverture…',
    'Choix de la palette et de l’ambiance…',
    'Réglage des transitions de scène…',
    'Composition du mouvement pour chaque temps…',
  ...
  app: [
    ...
    'Choix des composants et du parcours…',
    'Câblage des interactions…',
    'Soin de la finition visuelle…',
    'Vérification des cas limites…',
    'Assemblage de la version finale…',
  ],
  image: [
    'Lecture de votre description…',
    'Cadrage de la composition…',
    'Choix de la lumière et de la palette…',
    'Raffinement du sujet et des détails…',
...
function buildSystemPrompt(surface: PulseSurface): string {
  return [
    ...
    'Write the lines in FRENCH. The product is French-first: every line must be natural French, present tense, no anglicisms.',
