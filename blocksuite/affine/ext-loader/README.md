# @blocksuite/ClickDz Work-ext-loader

Blocksuite extension loader system for ClickDz Work, providing a structured way to manage and load extensions in different contexts.
...
```typescript
import { BaseExtensionProvider } from '@blocksuite/ClickDz Work-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@blocksuite/ClickDz Work-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@blocksuite/ClickDz Work-ext-loader';
import { z } from 'zod';
