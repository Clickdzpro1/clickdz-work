...
You can login with the user (dev@clickdz.ai / dev) above to test the server.

## Done

Now you should be able to start developing ClickDz Work with server enabled.
...
yarn ClickDz Work server prisma studio
```

### Seed the db

```sh
yarn ClickDz Work server seed -h
```
